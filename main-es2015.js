...
RedflagComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RedflagComponent, selectors: [["app-redflag"]], decls: 13, vars: 0, consts: [[1, "app-body", "bg-green-gradient", "page-redflag"], [1, "main", "d-flex", "align-items-center"], [1, "container"], [1, "row"], [1, "col-lg-12", "mx-auto"], [1, "card-transparent", "bg-transparent"], [1, "img-logo"], ["src", "../../../../assets/img/logo-anyday.png", "alt", "Alternate Text"], [1, "text-wrapper"], [1, "icon-wrapper"], [1, "icon-sad"], [1, "text-secondery"]], template: function RedflagComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
